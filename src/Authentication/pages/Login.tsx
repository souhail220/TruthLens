      ...
      <div className="flex-1 flex flex-col items-center justify-center px-4 py-8 sm:py-12">
        <div className="w-full max-w-md">
          ...
          <div className="mb-12 text-center">
            ...
            <p className="text-gray-600 mt-3">Connectez-vous à votre compte</p>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#345AFB] focus:border-transparent transition-all"
                />
              </div>
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full bg-[#345AFB] text-white py-3 rounded-lg font-semibold hover:bg-[#1827dd] transition-colors disabled:opacity-75 disabled:cursor-not-allowed"
              >
          ...
          <p className="text-center text-gray-600 text-sm mt-6">
            ...
            <Link to="/signup" className="text-[#345AFB] font-semibold hover:text-[#1827dd] transition-colors">
              S'inscrire
            </Link>
          </p>
        </div>
